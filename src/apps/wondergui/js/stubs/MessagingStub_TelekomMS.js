 ...
 * For websocket
 */
function MessagingStub_TelekomMS() {
  this.ownRtcIdentity;
  this.credentials;
 ...
 */
MessagingStub_TelekomMS.prototype.sendMessage = function(message) {
  /*
 ...
 */
MessagingStub_TelekomMS.prototype.connect = function(ownRtcIdentity, credentials, callbackFunction) {
 ...
 */
MessagingStub_TelekomMS.prototype.disconnect = function() {
