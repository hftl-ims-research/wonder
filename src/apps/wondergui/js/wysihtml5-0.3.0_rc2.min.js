...
window.rangy = function () {
    ...
    var g = "object",
        k = "function",
        j = "undefined",
        q = "startContainer,startOffset,endContainer,endOffset,collapsed,commonAncestorContainer,START_TO_START,START_TO_END,END_TO_START,END_TO_END".split(","),
...
rangy.createModule("DomRange", function (b) {
    ...
    function d(a, b, c) {
        if (b = a._listeners[b])
            for (var d = 0, g = b.length; d < g; ++d) b[d].call(a, {
                target: a,
                args: c
            })
    }
    ...
    function J(a, b, c, g, e) {
        var j = a.startContainer !==
            b || a.startOffset !== c,
            k = a.endContainer !== g || a.endOffset !== e;
        a.startContainer = b;
        a.startOffset = c;
        a.endContainer = g;
        a.endOffset = e;
    ...
    D.prototype = {
        ...
        intersectsNode: function (b, c) {
            ...
            var d = b.parentNode,
                g = l.getNodeIndex(b);
            t(d, "NOT_FOUND_ERR");
            var e = l.comparePoints(d, g, this.endContainer, this.endOffset),
                d = l.comparePoints(d, g + 1, this.startContainer, this.startOffset);
        ...
        intersectsRange: function (b, c) {
            ...
            var d = l.comparePoints(this.startContainer, this.startOffset, b.endContainer, b.endOffset),
                g = l.comparePoints(this.endContainer, this.endOffset, b.startContainer, b.startOffset);
...
rangy.createModule("WrappedRange", function (b) {
    ...
    function a(a, b) {
        var c, d, f = a.offset,
            h = e.getDocument(a.node),
            i = h.body.createTextRange(),
...
rangy.createModule("WrappedSelection", function (b, c) {
    ...
    function r(a) {
        ...
        if ("undefined" != typeof a.rangeCount)
            for (var g = 0, j = a.rangeCount; g < j; ++g) b[g] = x.inspect(a.getRangeAt(g));
...
wysihtml5.browser = function () {
    ...
    return {
        ...
        supportsCommand: function () {
            var b = {
                    formatBlock: a,
                    insertUnorderedList: a || h,
                    insertOrderedList: a || h
                },
                c = {
                    insertHTML: d
                };
...
wysihtml5.dom.parse = function () {
    ...
    var a = {
            1: function (a) {
                ...
                if (x)
                    for (t in x)
                        if (s = g[x[t]]) s = s(c(a, t)), "string" === typeof s && (i[t] = s);
                r && w.push(r);
                if (m)
                    for (t in m)
        ...
        c.observe(e.element.ownerDocument, "keydown", function (h) {
            ...
            if (!(h.shiftKey || i !== b.ENTER_KEY && i !== b.BACKSPACE_KEY)) {
                ...
                (g = c.getParentElement(g, {
                    nodeName: a
                }, 4)) ? "LI" === g.nodeName && (i === b.ENTER_KEY || i === b.BACKSPACE_KEY) ? setTimeout(function () {
    ...
    b.Selection = Base.extend({
        ...
        selectNode: function (a) {
            var d = rangy.createRange(this.doc),
                ...
                h = e ? a.innerHTML : a.data,
                h = "" === h || h === b.INVISIBLE_SPACE,
...
(function (b) {
    function c(c, h) {
        ...
        for (g = j.length; k < g; k++)
            for (n in q = j[k], q.removeAttribute("class"), h) q.setAttribute(n, h[n]);
        k = q;
    ...
    b.commands.createLink = {
        exec: function (a, b, d) {
            ...
            g ? a.selection.executeAndRestore(function () {
                for (var a = g.length, b = 0, c, d, f; b < a; b++) c = g[b], d = e.getParentElement(c, {
                    nodeName: "code"
...
(function (b) {
    ...
    b.commands.formatBlock = {
        exec: function (g, k, j, q, n) {
            var p = g.doc,
                r = this.state(g, k, j, q, n),
                m, j = "string" ===
...
(function (b) {
    b.commands.insertOrderedList = {
        exec: function (c, a) {
            var d = c.doc,
                e, f, h;
            c.commands.support(a) ? d.execCommand(a, !1, null) : (e = c.selection.getSelectedNode(), (h = b.dom.getParentElement(e, {
                nodeName: ["UL", "OL"]
            }, 4)) ? c.selection.executeAndRestoreSimple(function () {
...
(function (b) {
    ...
    b.views.Composer.prototype.style = function () {
        var j = this,
            q = a.querySelector(":focus"),
            n = this.textarea.element,
            p = n.hasAttribute("placeholder"),
            r = p && n.getAttribute("placeholder");
    ...
    b.toolbar.Toolbar = Base.extend({
        ...
        _getLinks: function (a) {
            for (var c = this[a + "Links"] = b.lang.array(this.container.querySelectorAll("a[data-wysihtml5-" +
                a + "]")).get(), e = c.length, f = 0, h = this[a + "Mapping"] = {}, i, g, k, j; f < e; f++) i = c[f], g = i.getAttribute("data-wysihtml5-" + a), k = i.getAttribute("data-wysihtml5-" + a + "-value"), j = this._getDialog(i, g), h[g + ":" + k] = {
                link: i,
                name: g,
                value: k,
                dialog: j,
