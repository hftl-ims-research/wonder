 ...
 *
 */
function MessagingStub_OpenImsLocal() {
  this.ownRtcIdentity;
  this.credentials;
 ...
 * @param message
 */
MessagingStub_OpenImsLocal.prototype.sendMessage = function(message) {
...
MessagingStub_OpenImsLocal.prototype.connect = function(ownRtcIdentity, credentials, callbackFunction, errorCallbackFunction) {
 ...
 */
MessagingStub_OpenImsLocal.prototype.onSocketMessage = function(event, self) {
  var that = this;
...
MessagingStub_OpenImsLocal.prototype.handleMessage = function(msg, wonderMsg, self) {
...
MessagingStub_OpenImsLocal.prototype.disconnect = function() {
  if (this.socket)
    this.socket.close();
  this.socket = null;
...
MessagingStub_OpenImsLocal.prototype.doSend = function(message) {
  var msgString = JSON.stringify(message);
  console.log("send message " + msgString);
  this.socket.send(msgString);
};

MessagingStub_OpenImsLocal.prototype.ims2CloudMessage = function(message_command, status_code, attributes) {
  var msg = new Object();
