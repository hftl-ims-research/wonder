 ...
 * For websocket
 */
function MessagingStub_ClearwaterMS() {
  this.ownRtcIdentity;
  this.credentials;
 ...
 */
MessagingStub_ClearwaterMS.prototype.sendMessage = function(message) {
  /*
 ...
 */
MessagingStub_ClearwaterMS.prototype.connect = function(ownRtcIdentity, credentials, callbackFunction) {
  this.ownRtcIdentity = ownRtcIdentity;
  this.credentials = credentials;

  //DEFINE THE HOST ADDR
  var signaling_server = "192.168.7.126:8282";
 ...
 */
MessagingStub_ClearwaterMS.prototype.disconnect = function() {
