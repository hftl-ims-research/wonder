 ...
 *
 */
function MessagingStub_IMS2Cloud() {
  this.ownRtcIdentity;
  this.credentials;
 ...
 * @param message
 */
MessagingStub_IMS2Cloud.prototype.sendMessage = function(message) {
...
MessagingStub_IMS2Cloud.prototype.connect = function(ownRtcIdentity, credentials, callbackFunction, errorCallbackFunction) {
 ...
 */
MessagingStub_IMS2Cloud.prototype.onSocketMessage = function(event, self) {
  var that = this;
...
MessagingStub_IMS2Cloud.prototype.handleMessage = function(msg, wonderMsg, self) {
...
MessagingStub_IMS2Cloud.prototype.disconnect = function() {
  if (this.socket)
    this.socket.close();
  this.socket = null;
...
MessagingStub_IMS2Cloud.prototype.doSend = function(message) {
  var msgString = JSON.stringify(message);
  console.log("send message " + msgString);
  this.socket.send(msgString);
};

MessagingStub_IMS2Cloud.prototype.ims2CloudMessage = function(message_command, status_code, attributes) {
  var msg = new Object();
